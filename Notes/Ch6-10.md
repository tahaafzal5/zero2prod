...
* “Current span” means “active span for the current thread”.
  ...
  * We added a `spawn_blocking_with_tracing` function in telemetry.rs that we can easily reach for whenever we need to offload CPU-intensive computation to a dedicated threadpool.
