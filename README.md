...
2. Make sure postgres accepts remote connections
3. Run the migrations `DATABASE_URL="postgres://<postgres-user>:<postgres-pswd>@192.168.40.124:5432/newsletter" sqlx migrate run`
   * Make sure any special characters in the password are encoded properly.
4. Deploy and run the app on raspberrypi
   *  
